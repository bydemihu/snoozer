...
exports.MEDIAPIPE_FACE_MESH_KEYPOINTS = exports.MEDIAPIPE_FACE_MESH_CONNECTED_KEYPOINTS_PAIRS = exports.MEDIAPIPE_FACE_MESH_KEYPOINTS_BY_CONTOUR = exports.MEDIAPIPE_FACE_MESH_NUM_KEYPOINTS_WITH_IRISES = exports.MEDIAPIPE_FACE_MESH_NUM_KEYPOINTS = void 0;
exports.MEDIAPIPE_FACE_MESH_NUM_KEYPOINTS = 468;
exports.MEDIAPIPE_FACE_MESH_NUM_KEYPOINTS_WITH_IRISES = 478;
...
exports.MEDIAPIPE_FACE_MESH_KEYPOINTS_BY_CONTOUR = {
...
exports.MEDIAPIPE_FACE_MESH_CONNECTED_KEYPOINTS_PAIRS = [
 ...
 * ]
 */
var indexLabelPairs = Object.entries(exports.MEDIAPIPE_FACE_MESH_KEYPOINTS_BY_CONTOUR)
    .map(function (_a) {
    var label = _a[0], indices = _a[1];
    return indices.map(function (index) { return [index, label]; });
})
    .flat();
exports.MEDIAPIPE_FACE_MESH_KEYPOINTS = new Map(indexLabelPairs);
